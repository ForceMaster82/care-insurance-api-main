...
object ReconciliationAccessPolicy : AccessPolicy {
    override fun check(sub: Subject, act: Action, obj: Object) {
        ...
        } else if (actionType.contains(ActionType.MODIFY)) {
            denyIfNotInternalUser(sub)
        } else {
    ...
    private fun denyIfNotInternalUser(sub: Subject) {
        ...
        throw AccessDeniedException("대사 자료에 접근하기 위해서는 내부 사용자 권한이 필요합니다.")
    }
}
