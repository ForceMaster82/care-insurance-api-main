...
object DailyCaregivingRoundSettlementTransactionStatisticsAccessPolicy : AccessPolicy {
    ...
    private fun denyIfNotInternalUser(sub: Subject) {
        ...
        throw AccessDeniedException("날짜/간병회차별 정산금 입출금 통계를 조회하기 위해서는 내부 사용자 권한이 필요합니다.")
    }
}
