...
object DailySettlementTransactionStatisticsAccessPolicy : AccessPolicy {
    override fun check(sub: Subject, act: Action, obj: Object) {
        ...
        if (actionType.contains(ActionType.READ_ONE)) {
    ...
    private fun denyIfNotInternalUser(sub: Subject) {
        ...
        throw AccessDeniedException("날짜별 정산금 입출금 통계를 조회하기 위해서는 내부 사용자 권한이 필요합니다.")
    }
}
