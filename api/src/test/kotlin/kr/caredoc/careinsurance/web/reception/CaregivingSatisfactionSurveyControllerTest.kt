...
@CareInsuranceWebMvcTest(CaregivingSatisfactionSurveyController::class)
class CaregivingSatisfactionSurveyControllerTest(
    private val mockMvc: MockMvc,
    @MockkBean(relaxed = true)
    private val caregivingSatisfactionSurveyReserveCommandHandler: CaregivingSatisfactionSurveyReserveCommandHandler,
) : ShouldSpec({
    context("간병 만족도 조사를 예약하면") {
        val request = post("/api/v1/caregiving-satisfaction-surveys")
